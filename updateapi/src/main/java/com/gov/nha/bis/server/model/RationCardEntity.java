...
@Entity
@Table(name="rationcarddetails")
@Access(value=AccessType.FIELD)
@SequenceGenerator(name="rationcarddetailsseq" , sequenceName="rationcarddetailsseq", allocationSize=1)
public class RationCardEntity implements Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = -4864402824571568459L;
	@Id
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="rationcarddetailsseq")
	private Long id ;
