...
public class BenUpdateCardStatusService {
	...
	public String benUpdateCardStatus(Long refernceid,String stateCode,int status,String urFlag,String usrId) {
		
		String response="";
		
		response=getSaveDemo(getbeneficiaryUpdateStatusRequestJson(refernceid, stateCode,
				status,urFlag,usrId), applicationConstantConfig.KAFKA_BEN_CARD_STATUS_UPDATE_URL);
