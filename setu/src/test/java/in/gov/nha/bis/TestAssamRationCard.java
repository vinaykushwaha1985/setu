 ...
 */
public class TestAssamRationCard {

	public static void main(String[] args) {

		TestAssamRationCard tjk= new TestAssamRationCard();
	...
	//	NhaSSSLUtil.setDefaultSSL();
		...
		String response=tjk.sendReq2(tjk.reqJson(accessToken, tjk.getCode()), "https://apis-prd.pmjay.gov.in/Ayushmanbharat_AS/api/values/post");
	...
	public String reqJson(String accessToken,String token) {
		...
		req.put("ID_Type", "2");
		req.put("ID_Number", "188000015963");
		req.put("Token", token);
		req.put("state_code", "18");
