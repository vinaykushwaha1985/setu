...
public class TestHaryanaRationCard {


	public static void main(String[] args) {

		TestHaryanaRationCard tjk= new TestHaryanaRationCard();
		...
		String response=tjk.sendReq2(tjk.reqJson(accessToken, tjk.getCode()), "https://apis-prd.pmjay.gov.in/PMJAY/HR/getPDSDetail");
	...
	public String reqJson(String accessToken,String token) {
		...
		req.put("ID_Type", "2");
		req.put("ID_Number", "066000000018");
		req.put("Token", token);
		req.put("state_code", "06");
