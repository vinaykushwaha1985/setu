 ...
 */
public class TestJKRationCard {

	public static void main(String[] args) {

		TestJKRationCard tjk= new TestJKRationCard();
		...
		String response=tjk.sendReq2(tjk.reqJson(accessToken, tjk.getCode()), "https://apis-prd.pmjay.gov.in/PMJAY/JK/getPDSDetail");
