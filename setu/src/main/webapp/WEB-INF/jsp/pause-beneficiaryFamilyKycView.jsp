...
<head>
  ...
  <title>Setu || Ayushman Card</title>
...
<body class="hold-transition sidebar-mini" onload="validateAction()">
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
     ...
     <li class="nav-item d-none d-sm-inline-block">
        <a href="/<%=requestUri%>/home" class="nav-link">Home</a>
      </li>
	...
	<li class="nav-item dropdown user-menu">
        <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
		 <%if(ObjectUtils.isEmpty(sessionUser.getPht())){ %>
            <img src="image/businessman.png" class="img-circle elevation-2" alt="User Image" width="30" height="30">
			 <%} else{ %> 
			<img src="data:image/jpeg;base64,<%=sessionUser.getPht()%>" class="img-circle elevation-2" alt="User Image" width="30" height="30"> 
           <%}%>
          <span class="d-none d-md-inline"><%=userId %></span>
        </a>
        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <!-- User image -->
		
		  <li class="user-header bg-primary" style="height: 288px;">
           <%if(ObjectUtils.isEmpty(sessionUser.getPht())){ %>
           <img src="image/businessman.png" class="img-circle elevation-2" alt="User Image">
           <%} else{ %> 
           <img src="data:image/jpeg;base64,<%=sessionUser.getPht()%>" class="img-circle elevation-2" alt="User Image">
           <%}%>
		   <p>
			  <%=sessionUser.getName() %> 
         	<small>Dob :  <%=sessionUser.getDob() %></small>
			<small>Gender :  <%=sessionUser.getGender() %></small>
			<small>Address :  <%=sessionUser.getAdr() %></small> 
			<small>Pin :  <%=sessionUser.getPin() %></small> 
			<small>District :  <%=sessionUser.getDistrict() %></small>
            <small>State :  <%=sessionUser.getState() %></small>
			
            </p>
          </li>
          <!-- Menu Footer-->
          <li class="user-footer">
           <a href="/<%=requestUri%>/logout" class="btn btn-default btn-flat float-right">Sign out</a>
          </li>
        </ul>
      </li>
...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="/<%=requestUri%>/home" class="brand-link">
      <img src="image/BISCenterLogo.png" alt="NHA Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="beneficiaryFamilyDetails" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Family Memeber's</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="beneficiaryFamilyDetails" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Family Memeber</p>
                </a>
              </li>
             </ul>
          </li>
