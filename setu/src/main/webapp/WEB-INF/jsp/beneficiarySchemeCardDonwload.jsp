              ...
              <div class="row">
                <div class="beneficiary-view-tabs mb-1  col-sm-12 col-md-6 mx-auto">
                  <ul class="nav nav-pills" id="pills-tab" role="tablist" >
                    ...
                    <li class="nav-item w-50" role="presentation">
                      <button class="nav-link" id="pills-review-tab" data-bs-toggle="pill" data-bs-target="#pills-review" type="button" role="tab" aria-controls="pills-review" aria-selected="false" disabled>Add Member</button>
                    </li>
                  </ul>
                      ...
                      <div class="tab-card-in">
    					...
    					<span>Verifying...</span>
                          ...
                          <div class="text-center mt-3">
                            <a class="btn btn-sm btn-white" href="/<%=requestUri%>/stateSchemeSearch">Back to Search</a>
