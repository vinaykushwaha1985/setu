                    ...
                    <body class="mobile" onload="onOpenAction()">
                            ...
                            <div class="beneficiary-section">
                              <main>
                                <section class="SECC-data mb-4">
                                  <div class="container">
                                    <form:form action="" method="POST" id="registration" commandName="command" enctype="multipart/form-data"  >
                                            ...
                                            <div class="tab-content tab-content-view" id="pills-tabContent">
                                                      ...
                                                      <div class="custom-form-group form-group">
                                                        ...
                                                        <div
                                                          ...
                                                          <div id="otp-home-tab" class="form-radio" >
                                                            <input type="radio" id="radioO" name="ekyc-new" value="O" checked 
                                                        ...
                                                        <div class="tab-content mt-4" id="pills-tabContent">
                                                          ...
                                                          <div class="authenticate-wrap tab-pane fade show active" id="otp-home"
                                              ...
                                              <div class="tab-pane fade" id="pills-review" role="tabpanel"
                                                ...
                                                <div class="tab-card-in">
                                                  ...
                                                  <h3>Beneficiary Details as in ACDC Ration  </h3>
                                                <%}else  if(beneficiarySeccForm.getSchemeid().equalsIgnoreCase("5")) { %> 
                                                 <h3>Beneficiary Details as in ACDC Mobile  </h3>
                                                 <%}else  if(beneficiarySeccForm.getSchemeid().equalsIgnoreCase("2")) { %> 
                                                  ...
                                                  <%}else  if(beneficiarySeccForm.getSchemeid().equalsIgnoreCase("3")) { %> 
                                                   <h3>Beneficiary Details as in MMJAA UP  </h3>
                                                   <%}else  if(beneficiarySeccForm.getSchemeid().equalsIgnoreCase("6")) { %> 
                                                    <h3>Beneficiary Details as in BOCW  </h3>
                                                    <%}%> 
                                                  ...
                                                  <h3>Sub Scheme Document Detail </h3>
                                                  <div class="row mx-0 mb-4">
                                                    <div class="col-12 col-sm-6 col-md-4 col-lg-3 tab-card-in-seccdata">
                                                      <span>Sub Scheme Name: </span>
													     <strong id="subSchemeName">
														<%=beneficiarySeccForm.getSubSchemeName() %>
													  </strong>
                                                    </div>
                                                    <div class="col-12 col-sm-6 col-md-4 col-lg-3 tab-card-in-seccdata">
                                                      <span>Document Type Name: </span>
                                                     <strong id="subSchemeDocumentTypeName" >
                                                     	<%=beneficiarySeccForm.getDocumentTypeName() %>
                                                     </strong>
                                                    </div>
                                                    <div class="col-12 col-sm-6 col-md-4 col-lg-3 tab-card-in-seccdata">
                                                      <span>Document Type ID: </span>
                                                       <strong id="subSchemeDocumentTypeId">
                                                      <%=beneficiarySeccForm.getDocumentViewId() %>
                                                       </strong>
                                                    </div>
                                                    <div class="col-12 col-sm-6 col-md-4 col-lg-3 tab-card-in-seccdata">
                                                      <span>Document Image: </span>
                                                       <strong id="subSchemeDocumentTypeImage">
                                                       <img id="docImageId" class="me-2" src="data:image/jpeg;base64,<%=beneficiarySeccForm.getPhoto() %>" alt="" width="100" height="100">
                                                        </strong>
                                                    </div>
                                                  ...
                                                  <div class="row my-3 justify-content-center">
    												<div class="col-12 col-sm-3 col-md-3 col-lg-3 mb-1">
						                              <div class="custom-form-group form-group mb-0"> 
						                                <input id="imageFile" name="imageFile" path="imageFile" type="file" class="form-control" accept="image/gif, image/jpeg, image/png" >
						                              </div>
						                             </div>
						                             
				                             	   <div class="col-12 col-sm-1 col-md-1 col-lg-1 mb-1 text-center pt-2"></div>

						                           <div class="col-12 col-sm-3 col-md-3 col-lg-2 mb-1 text-center">
													<!-- <button type="button" class="btn btn-sm btn-dark">Capture</button> -->
												   </div>

												    <div class="col-12 col-sm-3 col-md-3 col-lg-2 mb-1" style="display: none;">
									  ...
									  <form:hidden path="subSchemeId" id="subSchemeId" />
                                      <form:hidden path="documentTypeId" id="documentTypeId" />
                                      <form:hidden path="documentId" id="documentId" value="<%=beneficiarySeccForm.getDocumentViewId() %>" />
                                      <form:hidden path="photo" id="docphoto" value="<%=beneficiarySeccForm.getPhoto() %>" />
                                      <form:hidden path="photoName" id="photoName" />
                      ...
                      <script type="text/javascript">
                        ...
                        function saveKycData() {
                          ...
                          var chekedRUFlag = '<%=beneficiarySeccForm.getRuralUrbanFlag()%>';
                          var stateScheme ='<%=beneficiarySeccForm.getStateScheme()%>';
						  ...
						  var docphoto = document.getElementById("docphoto").value;
						  ...
						  formData.append("imageFile", imageFile.files[0]);
                           ...
                           //formData.append("demoName", name_d);
                       ...
                       //    formData.append("father_name_eng", father_name_eng);
                        //   formData.append("spouse_name_eng", spouse_name_eng);
                         ...
                         ///  formData.append("pincode", pincode);
                          // formData.append("rural_urban", rural_urban);
                           ...
                           formData.append("stateScheme",stateScheme);
                           //formData.append("schemeid",schemeid);
                           //formData.append("subSchemeId",subSchemeId);
                          ...
                          if (document.getElementById("checkDeclare").checked) {
                            ...
                            $.ajax({
                              ...
                              url: "/" + requestUri + "/saveKycSchemeData",
                              data: formData,
                              processData: false,
         					  contentType: false,
                              ...
                              success: function (data) {
                                ...
                                if (obj['status'] == "Y") {
                                  ...
                                  $('#errorUpdateKyc').html("Beneficiary Already Apply for Scheme.");
                                  $('#infoUpdateKyc').hide('slow');
                                  $('#errorUpdateKyc').show('slow');
                                  document.getElementById("finishButton").disabled = false;
                        ...
                        function goHome() {
                          ...
                          var requestUri = '<%=requestUri%>';
                          window.location.href = "/" + requestUri + "/stateSchemeSearch";
                        }
