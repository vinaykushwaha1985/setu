...
@Controller
public class FacePhotoController extends NhaBisBaseController{


	private static final Logger logger = LogManager.getLogger(FacePhotoController.class);
	...
	@RequestMapping(value="/facePhoto",method = RequestMethod.POST)
