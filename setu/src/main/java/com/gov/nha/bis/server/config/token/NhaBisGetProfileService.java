...
@Service
public class NhaBisGetProfileService {
	
	private static final Logger logger = LoggerFactory.getLogger(NhaBisGetProfileService.class);

	public  String getProfilePicOauth2_0(String clientId,String clientSecret,String OAUTH_ACCESS_TOKEN_URL){
