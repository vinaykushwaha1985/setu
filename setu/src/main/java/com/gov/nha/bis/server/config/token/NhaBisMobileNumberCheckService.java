...
@Service
public class NhaBisMobileNumberCheckService {
	
	private static final Logger logger = LoggerFactory.getLogger(NhaBisMobileNumberCheckService.class);

	public  String getMobileNumberOauth2_0(String clientId,String clientSecret,String OAUTH_ACCESS_TOKEN_URL){
